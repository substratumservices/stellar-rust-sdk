...
impl Render<Ledger> for Simple {
    fn render(&self, ledger: &Ledger) -> Option<String> {
        ...
        append!(buf, "successful transaction count: {}", ledger.successful_transaction_count());
        append!(buf, "failed transaction count:     {}", ledger.failed_transaction_count());
        ...
        append!(buf, "base reserve:                 {}", ledger.base_reserve_as_amount());
